  ...
  return (
    <div className="flex flex-row h-60 md:h-96 xxl:h-screen/2	" style={props.backgroundStyle}>
      ...
      <div className="w-3/5 font-poppins flex flex-col justify-center pr-1 pl-3 sm:pl-8 md:pl-8 lg:pl-9 xl:pl-10 xx:pl-12">
        <div className="text-lg font-bold pb-1 text-lg sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl xxl:text-7xl" >{props.title}</div>
        <div className="text-xs font-light text-xm sm:text-lg md:text-lg lg:text-xl xl:text-2xl xxl:text-3xl" >{props.description}</div>
      </div>
