...
const Footer = () => {
  return (
    <div className="bg-gray-800 text-white font-poppins pt-8 pb-6 pl-4 pr-4 flex flex-row">
      {/* Logo */}
      <div className="w-1/2 flex flex-wrap justify-center content-center pr-4">
        <img className="w-38 inline-block align-middle mx-auto" src="https://i.imgur.com/ZL6O7w3.png" alt="Isotipo Nido" />
      </div>
      {/* Nav */}
